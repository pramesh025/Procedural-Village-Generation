...
class ZeGraph: #SINGLETON
    def __init__(self, gameMeshes, gameMaterials) -> None:
        ...
        self.addNode(ZeNode("WoodFloor", BuildingPart(self.CwoodFloor),100))                #1   WoodFloor
        self.addNode(ZeNode("Sand", BuildingPart(self.Csand),100))                          #2   Sand
        ...
        self.nodes[1].nexts = [ {3,4,5,6,1,7,8,9,12},  #0, x
                                {3,4,5,6,1,7,8,9,12},  #1, y
                                {3,4,5,6,1,7,8,9,12},  #2, -x
                                {3,4,5,6,1,7,8,9,12}]  #4, -y
    ...
    def possibilities1D(self, node, direction):
